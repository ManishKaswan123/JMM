...
interface HiredetailsDetailsProps {
  data: ContractorHiredetailsDetails
  onGoBack: () => void
}
export const HiredetailsDetailsCard: React.FC<HiredetailsDetailsProps> = ({data, onGoBack}) => {
  return (
    <div className='bg-white rounded-lg p-6 shadow-lg border border-gray-300 mx-4 my-8 w-full relative'>
      ...
      {/* Title */}
      <h2 className='text-4xl font-bold mb-6 text-center'>Contractor Hire Details</h2>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div className='space-y-4'>
          <div className='flex items-center'>
            <strong className='font-medium text-lg mr-2'>Destination:</strong>
            <p>{data.destination}</p>
          </div>
          <div className='flex items-center'>
            <strong className='font-medium text-lg mr-2'>Joining Date:</strong>
